ActiveAdmin.register TrainDetail do
  ...
  #   permitted
  # end
  permit_params :train_code, :from, :to, :days, :departure_time, :arrival_time, 
                :distance_km, :travel_time_hrs, :class_2a_count, 
                :class_2a_price, :class_1a_count, :class_1a_price, 
                :class_general_count, :class_general_price, :train_name
  ...
  form do |f|
    f.inputs do
      ...
      f.input :to
      f.input :days
      f.input :departure_time, as: :time_select, label: 'Departure Time', include_blank: true
      f.input :arrival_time, as: :time_select, label: 'Arrival Time', include_blank: true
      f.input :distance_km
